// Digital Twins research detail page
...
export const metadata: Metadata = {
  title: "Digital-Twins for Sensing - WiRES Lab",
  description:
    "Designing wireless simulators and novel perception models for next-generation digital twin systems.",
};

export default function DigitalTwinsPage() {
  // Find the digital-twins research area from the shared data
  const area = researchAreas.find((a) => a.slug === "digital-twins");
